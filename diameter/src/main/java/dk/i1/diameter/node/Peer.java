...
public class Peer {
	...
	public Peer(String host_name,String host, int port, TransportProtocol transport_protocol) throws EmptyHostNameException {
		if(host.length()==0)
	...
	public void host_name(String host_name){
		this.host_name=host_name;
	}
	public String host() {
		return host;
