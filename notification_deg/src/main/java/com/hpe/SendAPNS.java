...
public class SendAPNS {
	...
	public static void Send() throws UnrecoverableKeyException, KeyManagementException, CertificateException, NoSuchAlgorithmException, KeyStoreException, IOException {
		...
		FileInputStream cert = new FileInputStream("C:\\Project\\HPDEG\\MTS_DEG\\Requirement\\cert\\apns\\ech_prod.p12");
		final ApnsClient client = new ApnsClientBuilder()
		        .withDevelopmentGateway()
		        .inSynchronousMode()
		        .withCertificate(cert)
		        .withPassword("Tud9P\\fT;dCqbuq2(5{\\")
		        .withDefaultTopic(apns_topic)
		        .build();
